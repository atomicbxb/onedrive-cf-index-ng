...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'atomic@kotakbiasa.onmicrosoft.com',
  ...
  protectedRoutes: ['/atomc'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:admin@atomic.my.id',
